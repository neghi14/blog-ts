...
blogRouter.get("/all", (req: Request, res: Response, next: NextFunction) => blogController.readAll(req, res, next));

blogRouter.post("/new", (req: Request, res: Response, next: NextFunction) => blogController.createOne(req, res, next));
